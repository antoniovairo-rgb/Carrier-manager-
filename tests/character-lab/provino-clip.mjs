...
await page.goto(`http://127.0.0.1:${server.address().port}/tests/character-lab/provino-clip.html?glb=${encodeURIComponent(process.env.CPM_GLB)}&clip=${process.env.CPM_CLIP}&t=${T}`);
