...
for (let p = DA; p < DA + N; p++) {
  ...
  esiti.push({ partita: p, fine, ultimo, scenaG, b4, b4ric, b4dif, highlight: hl, scene, perSrc, programmate, errori });
...
const out = path.join(here, 'scena-gesti'); fs.mkdirSync(out, { recursive: true });
