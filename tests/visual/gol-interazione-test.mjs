#!/usr/bin/env node
/* [7.999.13] la coincidenza gol + interazione non si cerca piu' in una partita fortunata (cambia a ogni ritocco del motore): la forza
   il gancio di collaudo __CPM_FORZA_INTXGOL. */
...
await page.addInitScript(r => { window.__CPM_GLB = false; window.__CPM_REC = true; window.__CPM_GOLPERSO_REC = 1; window.__CPM_FORZA_INTXGOL = 1; if (r) window.__CPM_NO_GOLINTX10 = 1; }, ROSSO);
