...
console.log('testimone parata:', JSON.stringify(await page.evaluate(() => ({ ...(window.__CPM_PARATA || {}), folla: window.__CPM_FOLLA23 || 'birilli', coppaSuEroe: window.__CPM_COPPA24 ?? null }))));
