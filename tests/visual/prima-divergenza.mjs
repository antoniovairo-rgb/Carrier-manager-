...
async function giro() {
  ...
  await page.addInitScript(() => {
    ...
    try { localStorage.setItem('cpm-match-speed', '1'); } catch (e) {}
  });
  try {
  ...
  } catch (e) { return { txt: [], rnd: {}, pos: {}, press: {}, who: {}, passi: {}, r14: {} }; }
  finally { await page.close().catch(() => {}); }
}

const A = await giro(), B = await giro();
...
console.log('\n=== CHE COSA DIVERGE PER PRIMO (due giri identici a 1x) ===');
