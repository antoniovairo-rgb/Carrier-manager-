...
for(let g=0;g<NOMI.length;g++){
  ...
  let cAnn=0,cBat=0;occ.forEach(o=>{const par=o[2];if(!par||!/angolo/i.test(par))return;cAnn++;
    ...
    if(m0!=null&&croT.some(c=>c.t>=m0&&c.t<=m0+8&&/Calcio d'angolo/i.test(c.txt)))cBat++;});/* finestra 8': il piano si chiude 4-7 tick dopo la parata */
