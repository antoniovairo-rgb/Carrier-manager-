...
├── VALIDATORS.md            ← standard universale + catalogo validator LMV-001..019 (cap. 1)
├── VALIDATORS_REMAINING.md  ← validator pianificati residui (10, backlog per nome)
├── ROADMAP.md               ← roadmap LMQP a 8 fasi + stato attuale
├── DEVELOPMENT_RULES.md     ← regole di sviluppo (sintesi di MASTER_PROMPT Parte 2)
