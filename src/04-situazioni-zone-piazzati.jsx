...
const COMMENTO_TECNICO={
  ...
  attack_goal:["Su questa palla bisogna crederci sempre.",{t:"Il movimento e' giusto: da li' conta il tocco, non la forza.",se:"shot"},"In area serve freddezza, non forza.","Dentro l'area il primo tocco decide tutto.",{t:"Il portiere ha coperto il palo, restava l'altro.",se:"save"},{t:"Un metro prima o un metro dopo, li' cambia tutto.",se:"shot"}],
