...
const BG_MATCH=[
  ...
  {txt:"🧤 Parata sicura! {GKH} blocca a terra senza problemi.",ef:null,w:2,bpos:{x:5,y:50},ms:{oppShots:1},pd:"defend_goal"},
  ...
  {txt:"🧤 Riflesso felino di {GKH}: deviazione sulla traversa!",ef:null,w:1.5,bpos:{x:6,y:50},ms:{oppShots:1},pd:"defend_goal"},
