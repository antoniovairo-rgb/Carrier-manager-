    ...
    const loop=()=>{
      ...
      if(ballArcActive){const _preT74=ballArcT;
        ...
        if(hlPostArcType==="in_net"){
          ...
          /* ⚠️ [7.799.0 — REVOCATO PER MANCANZA DI UN METRO, non per una misura contraria.
             Rosso storico __CPM_NO799.]
             Nota PO (7.787, SIT #153 «Bordata da centrocampo» → goal): «codice 111 — portiere fuori
             tempo». L'OSSERVAZIONE C'E' ED E' NETTA: in tutti i tuffi che sono riuscito a fotografare —
             cinque, su piu' passate — il tuffo si arma a 0,58-0,62 s su un volo di 0,57-0,60 s, cioe' un
             rapporto istante/durata di circa 1,03: il portiere si muove QUANDO IL PALLONE E' GIA'
             ARRIVATO. Non e' «tardi», e' «dopo».
             LA CAUSA E' LEGGIBILE: questo ramo (7.652) voleva un portiere battuto, giusto, ma l'ha legato
             alla POSIZIONE del pallone («ultime quattordici unita'»), e una soglia di posizione su una
             traiettoria che finisce in porta scatta per forza alla fine. Un portiere battuto vero parte
             quando parte il tiro e ci arriva tardi: e' l'allungo a essere corto, non la partenza a essere
             in ritardo.
             IL RIMEDIO PROVATO: armare il tuffo sul TEMPO (tre decimi dalla partenza dell'arco, il tempo
             di reazione di un portiere umano) quando un arco c'e', tenendo la soglia di posizione come
             ripiego. Alla ri-misura non ha spostato niente — e a quel punto ho guardato il METRO invece
             del rimedio.
             IL METRO NON REGGE, ed e' per questo che si revoca: il numero di tuffi osservati per passata
             e' stato 4, poi 3, poi 0, poi 0, poi 1, su codice quasi identico e su un campione portato
             fino a settantadue azioni forzate. Un metro che oscilla cosi' non puo' promuovere ne'
             bocciare un rimedio, ed e' la stessa lezione del 7.617 sul metro del portatore. In mezzo ho
             anche rotto io lo strumento: aggiungendo tre campi al testimone (stato dell'arco e post-arco)
             il conteggio e' andato a zero due volte di fila — non perche' il gioco fosse cambiato, ma
             perche' il testimone taceva.
             RESTA la strumentazione su TUTTI E NOVE i siti che armano il tuffo (la prima stesura ne
             copriva uno solo, e contava zero: uno zero che diceva qualcosa sulla sonda, niente sul
             gioco). Chi riprende il punto parte da un'osservazione precisa e da uno strumento che va
             prima reso ripetibile. */
