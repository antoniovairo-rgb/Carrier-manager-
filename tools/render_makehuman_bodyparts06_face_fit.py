"""Visual-only fit gate for CC0 MakeHuman Bodyparts 06 on the CGTrader face."""
...
ASSETS = Path(r"C:\Users\a.vairo\AppData\Local\Temp\makehuman-bodyparts06-ccby\clothes")
OUT = ROOT / "tests/character-lab/makehuman-bodyparts06-fit"
