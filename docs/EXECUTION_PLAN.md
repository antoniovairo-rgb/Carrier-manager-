...
|---|---|---|---|---|---|
| **A1 — Save safety** | #50 estrai migration in funzione pura · #2 test save-compat (save storici sintetici) · #3 `SAVE_VERSION` osservabile/stamp | `migratePlayer()` pura + test node | M | Basso-Medio | 🟡 in corso |
...
| **C2 — Camera/Ball/Physics** | #18 Camera · #41 no-boomerang/teleport live · #42 collisioni/inerzia | AC-041…048, 029/030, 091…100 | L |
