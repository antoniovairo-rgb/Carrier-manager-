...
| **C4 — AI Vision ponte** | **#35 Situation Recognition ✅** (run su 5.38.0: 4/4 `matchesExpected=true`, conf 70-75) + **#18 camera perceptual ✅** (scorata 50-65). Run reale: quality medio 55.6, 4×WARNING (second-level, non blocca CI). #36 video continuo · #34 cross-validation gate↔AI · #37 build comparison → prossimi (estensioni engine) | AC-161…170 (AI Vision ✅) | M · **#35/#18 fatti** |
