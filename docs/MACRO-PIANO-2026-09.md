...
| C5 | performance mobile: misura sull'Android del PO | fps ≥ 30 sul telefono del PO (da lui misurato) | **primo numero arrivato (21:30)**: corpi **pieni** media **31-32 fps**, massimo **38** — soglia superata già col pieno; manca il numero appaiato dei **leggeri**, quindi il guadagno della 7.907 sul telefono resta non verificato |
