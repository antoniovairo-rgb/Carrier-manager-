...
| cosa | numero | fonte |
|---|---|---|
| produzione (`main`) | **a97b492 = 7.908.0** (7.889 → 7.907 in produzione: C8 panchina, C3 v4 HUD, D7 corpi leggeri; 7.896 revocata) | verbale 20:22 |
...
| D12 | **il costo è per corpo, non per triangolo** (dalla misura del 21:35): i due GLB hanno le stesse 7 mesh, 7 skin, 73 nodi, 2 materiali — la leva vera è unire le mesh, ridurre le ossa per i corpi lontani e **ridurre i corpi in quadro** | chiamate di disegno per fotogramma: misurate dalla sonda `costo-corpo` · mesh per corpo 7 → 1-2 · fps sul telefono del PO ≥ 45 | **nuovo, al posto di D7** |
