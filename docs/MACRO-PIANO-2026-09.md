...
| A2 | 7.898 cadenza: il minuto del motore ha tre fasi (dt=1/3: una decide, due muovono la fisica); il pallone reso segue portatore o logico senza arco di cronaca | banco: padrone dichiarato 58,6 → 66,2 %, salti > 5u per chiamata 342 → 0 · telefono rosso → verde: ai piedi 53 → 55 %, padrone dichiarato 39 → 48 %, salti 66 → 46; scarto reso↔logico 1,2 → 2,4u (costo dichiarato); v1/v2 (7.896) e v3/v3b scartate a verbale | **sul branch** (8bea3c5), rituali in corsa → main |
